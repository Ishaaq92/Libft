...
SRCS = ft_atoi.c     ft_isalpha.c  ft_itoa.c    ft_memmove.c     ft_putnbr_fd.c  ft_strdup.c    ft_strlcpy.c  ft_strnstr.c  ft_tolower.c \
		...
		ft_isalnum.c  ft_isprint.c  ft_memcpy.c  ft_putendl_fd.c  ft_strchr.c     ft_strlcat.c   ft_strncmp.c  ft_substr.c get_next_line_bonus.c get_next_line_utils_bonus.c ft_lstnew.c ft_lstadd_front.c ft_lstsize.c ft_lstlast.c ft_lstdelone.c \
